...
DATA_DIR = '/home/titu/Documents/pyworkspace/Clusteringex'
...
def load_sent_word_net():
    ...
    with open(os.path.join(DATA_DIR, 'SentiWordNet_3.0.0_20130122.txt')) as csvfile:
...
def load_tweet_data():
    import csv
    corp = '/home/titu/Documents/pyworkspace/Clusteringex/full-corpus.csv'
    y = []
    x = []
